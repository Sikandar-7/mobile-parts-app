export default function MobileSocialIcons() {
  return (
    <div className="md:hidden w-full flex justify-center py-4 bg-white dark:bg-[#121212]">
      <div className="flex items-center gap-6">
        ...
        {/* TikTok */}
        <a href="#" className="hover:opacity-80 transition-opacity relative flex items-center justify-center bg-white rounded-md w-[22px] h-[22px]" aria-label="TikTok">
